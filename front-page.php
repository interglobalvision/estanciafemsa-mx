...
<main id="front-page" class="font-bolder">
  <a href="<?php echo home_url('/es/home'); ?>" class="front-page-block font-size-h1 line-tighter">
    <div class="col-l-9">
      <?php if (!empty($splash_text)) {echo $splash_text;} ?>&nbsp;>
    </div>
  </a>
  <a href="<?php echo home_url('/en/home'); ?>" class="front-page-block font-size-h1 line-tighter">
    <div class="col-l-9">
