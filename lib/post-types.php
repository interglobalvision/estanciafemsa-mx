...
function prensa_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Prensa', 'Post Type General Name', 'estanciafemsa_mx' ),
		'singular_name'         => _x( 'Prensa', 'Post Type Singular Name', 'estanciafemsa_mx' ),
		'menu_name'             => __( 'Prensa', 'estanciafemsa_mx' ),
		'name_admin_bar'        => __( 'Prensa', 'estanciafemsa_mx' ),
		'archives'              => __( 'Archivo', 'estanciafemsa_mx' ),
		'parent_item_colon'     => __( 'Entrada Padre', 'estanciafemsa_mx' ),
		'all_items'             => __( 'Todas las Entradas', 'estanciafemsa_mx' ),
		'add_new_item'          => __( 'Agregar Nueva Entrada', 'estanciafemsa_mx' ),
	...
	$args = array(
		'label'                 => __( 'Prensa', 'estanciafemsa_mx' ),
		'description'           => __( 'Presna', 'estanciafemsa_mx' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
